...
6. Run safe browser exploration with `npx --yes @noice-tech/demo-recorder@0.0.1 explore --url <url>`; add `--repo <path> --start '<command>'` for a managed local app.
7. Read `exploration.json`, `summary.md`, and relevant screenshots. Do not submit forms or use destructive controls during exploration.
