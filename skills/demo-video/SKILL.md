...
7. Read `exploration.json`, `summary.md`, observations, ARIA snapshots, and relevant screenshots. Use one bounded action at a time, treat refs as observation-scoped, and always finish or abort a persistent session. Do not submit forms or use destructive controls during exploration.
